...
class ClassSubjectController extends Controller
{
    ...
    public function insert (Request $request)
    {
        if(!empty($request->subject_id))
        {
            ...
            return redirect('admin/assign_subject/list')->with('success', "Subject Successfully Assigned to Course");
    ...
    public function update_single($id, Request $request)
    {
                ...
                return redirect('admin/assign_subject/list')->with('success', "Assigned Subject Successfully Updated");
