...
class AssignClassTeacherController extends Controller
{
     public function list(Request $request)
    {
        ...
        $data['header_title'] = "Assign Course Teacher";
    ...
    public function add(Request $request)
    {
        ...
        $data['header_title'] = "Add Assign Course Teacher";
    ...
    public function insert (Request $request)
    {
        if(!empty($request->teacher_id))
        {
            ...
            return redirect('admin/assign_class_teacher/list')->with('success', "Subject Successfully Assigned Course to Teacher");
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/assign_class_teacher/list')->with('success', "Assigned Class Teacher Successfully");
    }
    ...
    public function update_single($id, Request $request)
    {
                ...
                return redirect('admin/assign_class_teacher/list')->with('success', "Assigned Course Teacher Successfully Updated");
    ...
    public function delete($id)
    {
        ...
        return redirect()->back()->with('success', "Assigned Course Teacher Successfully Deleted");
