              ...
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="student_number" value="{{ old('student_number', $getRecord->student_number) }}" required placeholder="Student Number">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <p>Do you want to change your password? (optional)</p>
                  </div>
