...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign Course Teacher (Total :{{ $getRecord->total() }})</h1>
          </div>
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{ url('admin/assign_class_teacher/add') }}" class="btn btn-primary">Add New Assign Course Teacher</a>
        </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <form method="get" action="">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <a href="{{ url('admin/assign_class_teacher/list') }}" class="btn btn-success" style="margin-top: 31px;">Reset</a>
                    </div>
                  </div>
                  </div>
                </form>
                ...
                <div class="card">
              <div class="card-header">
                <h3 class="card-title">Assigned Course Teacher List</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <a href="{{ url('admin/assign_class_teacher/edit_single/'.$value->id) }}" class="btn btn-primary btn-sm">Edit Single</a>
