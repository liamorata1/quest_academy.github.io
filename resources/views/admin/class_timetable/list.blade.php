        ...
        <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Search Course Timetable</h3>
              </div>
                ...
                <div class="form-group col-md-5.5">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control getSubject" name="subject_id" required>
                        <option value="">Select</option>
                        @if(isset($getSubject) && !empty($getSubject))
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('admin/class_timetable/list') }}" class="btn btn-success" style="margin-top: 31px;">Reset</a>
                  </div>
                </div>
                </div>
              </form>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Course Timetable</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach($week as $value)
                        <tr>
                            <th>
                              <input type="hidden" name="timetable[{{ $i }}][week_id]" value="{{ $value['week_id'] }}">{{ $value['week_name'] }}
                            </th>
                            <td>
